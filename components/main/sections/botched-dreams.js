...
export default function BotchedDreams() {
  return (
    <section>
      <Image src={dirtyIlojo} alt="Picture of the author" layout="responsive" />
      <h4>1950&apos;s</h4>
      <h2>
        Botched<span>dreams for</span> Ilojo bar
      </h2>
      <Image src={cleanIlojo} alt="Picture of the author" layout="responsive" />
      <p>
      ...
      <Image src={statue} alt="Picture of the author" layout="responsive" />
      <p>
        Lorem Ipsum is simply dummy text of the printing and typesetting
        industry. Lorem Ipsum has been the industry&apos;s standard dummy text
        ever since the 1500s, when an unknown printer took a galley of type and
